                    ...
                    <div class="profile-card__about">
                        ...
                        <h5 class="">
                            <ul class="list--comma-separated">
                                <li>
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;">Kab. </font>
                                        <font style="vertical-align: inherit;">Tangerang</font>
                                    </font>
                                </li>
                                <li>
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;">Banten</font>
                                    </font>
                                </li>
                                <li>
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;">Indonésie</font>
                                    </font>
                                </li>
                            </ul>
                        </h5>
                        ...
                        <h5 class="no-bold text-sottovoce">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">Éducation/Formation</font>
                            </font>
                        </h5>
                        ...
                        <div class="profile-card__extras">
                            ...
                            <div class="profile-details__detail">
                                <div class="detail__label"><strong>
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">Activité récente</font>
                                        </font>
                                    </strong></div>
