...
<style>
    ...
    @media (min-width: 960px) {
        .photos .photo-1[data-v-e37e6fb6] {
            margin: 15% 0 0;
            width: 45%;
        }
    }
    ...
    @media (min-width: 960px) {
        .photos .photo-2[data-v-e37e6fb6] {
            margin: 0 0 0 4%;
            width: 40%;
        }
...
<body>
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center"><img src="/images/wim-sbg.png" alt="" srcset=""
            ...
            </nav><a href="/choix" class="get-started-btn">S'inscrire</a>
            <a href="/login" class="get-started-btn">Connexion</a>
        </div>
    </header><a href="/login" class="get-started-btn">Connexion</a></div>
    </header>
    <div class="banner"
            ...
            <div class="container"
                ...
                <div class="row" style="margin-right: -15px;
                    ...
                    <div class="banner-text text-center" style="
                            text-align: center;">
                        <div class="text-border" style="display: inline-block; margin-top: 150px;">
                            <h2 class="text-dec"
                        ...
                        <div class="intro-para text-center quote"
                            ...
                            <p class="big-text"
                                ...
                                <span style="vertical-align: inherit;"><span style="vertical-align: inherit;">Apprendre
                                        aujourd'hui. </span>
                                    <span style="vertical-align: inherit;">. </span><span
                                        style="vertical-align: inherit;">. </span><span
                                        style="vertical-align: inherit;">Diriger demain.</span></span>
                            </p>
                            <p class="small-text" style="font-size: 16px; margin: 0 0 10px;"><span
                                    style="vertical-align: inherit;"><span style="vertical-align: inherit;">Être mentoré
                                        permet d’accélérer son développement en tant que scientifique tout en permettant
                                        de prendre du recul,
                                    </span><span style="vertical-align: inherit;"></span></span><br><span
                                    style="vertical-align: inherit;"><span style="vertical-align: inherit;">de mieux
                                        évaluer ses options et prendre des décisions éclairées.</span></span></p><a
                                href="#footer" class="btn get-quote"
                                style="background-color: #C15DFB;
                                        color: #fff;
                                        transition: all 0.3s ease-in-out;
                                        margin-top: 10px;"><span
                                    style="vertical-align: inherit;"><span style="vertical-align: inherit;">DEVENIR
                                        MENTORE</span></span></a>
                        </div><a href="#feature" class="mouse-hover">
                            <div class="mouse"></div>
                        </a>
                    </div>
                </div>
    ...
    <section data-v-6e28144e="" class="gristresclair py-10"
        style="padding-top: 40px!important;
               padding-bottom: 40px!important;">
        <div data-v-6e28144e="" class="illus illus-geo-bottom d-md-none"
            style="background-image: url(/img/DA/illustrations/BACKGROUND/1A1_controlrocks-14.svg);
        ...
        <div data-v-6e28144e="" class="container"
            style="    width: 100%;
            padding: 12px;
            margin-right: auto;
            margin-left: auto;">
            <h2 data-v-6e28144e="" class="title-font text-uppercase subtitle mb-0 text-center"
                style="text-align: center!important; font-family: 'Poppins',sans-serif!important;
                ...
                <div id="content">
                    <nav id="breadcrumbs" style="display: none;">
                        <ul aria-label="Fil d'Ariane" class="breadcrumb breadcrumb-horizontal">
                            <li class="active only"><a href="/menotrs/create">Devenir mentoré</a><span
                                                ...
                                                <div class="journal-content-article">
                                                    <div class="bloc-contenu-blanc container">
                                                        ...
                                                        <p><span style="font-size:18px;">Être mentor,
                                                                ...
                                                                région vers la réussite,
                                                                grâce à votre expérience. C’est vous impliquer dans une
                                                                communauté structuré et en croissance qui vous permet
                                                                d’agir là où ça compte. C’est agir au sein d’une
                                                                communauté de plus de 1 500 mentors bénévoles ayant à
                                                                cœur le succès des apprenenants..&nbsp;
                                                            </span></p><a
            ...
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <div class="col-md-6 d-flex align-items-stretch">
                        <div class="card">
                            <div class="card-img"><img src="../images/g.jpg" alt="..."></div>
                            <div class="card-body">
                                <h5 class="card-title"><a href="">DEVENEZ MENTOR</a></h5>
                                <p class="card-text">Vous avez envie d'aider d'autres entrepreneurs? De contribuer au
                                    développement de la communauté entrepreneuriale? Vous êtes ou vous avez été un
                                    entrepreneur pendant plus de 5 ans avec gestion d'équipe?
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 d-flex align-items-stretch">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Vous avez envie d'aider d'autres entrepreneurs? De contribuer au
                                    développement de la communauté entrepreneuriale? Vous êtes ou vous avez été un
                                    entrepreneur pendant plus de 5 ans avec gestion d'équipe?</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section data-v-e37e6fb6="" class="py-10 relative"
        ...
        <div data-v-e37e6fb6="" class="d-md-flex relative">
            ...
            <div data-v-e37e6fb6="" class="photos">
                ...
                <div data-v-e37e6fb6="" class="photo-2 d-none d-sm-block"><img data-v-e37e6fb6=""
                        src="/images/enfant.webp" alt="" class="photo"
                        style="    width: 100%;
                        border-radius: 6px;"></div>
            </div>
