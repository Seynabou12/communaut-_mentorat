...
<body>
    ...
    <main id="main">
        ...
        <section id="counts" class="counts section-bg" style="background-color: #f9faf9;">
            <div class="container">
        ...
        <section
            style="background-image: url(https://assets.globalpartnership.org/s3fs-public/styles/standard_blog_banner/public/m._leandre_benon_enseignant_a_lecole_dakoitchaou_au_benin_et_une_de_ses_eleves_pendant_une_lecon_de_mathematiques.jpg);
                    ...
                    position: relative;"
            class="elementor-section elementor-top-section elementor-element elementor-element-4209eb4 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
            data-id="4209eb4" data-element_type="section"
            data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
            <div class="elementor-background-overlay"
                style="background-color: #C15DFB;
                        opacity: 0.2;
                        transition: background 0.3s, border-radius 0.3s, opacity 0.3s;height: 100%; width: 100%; top: 0;
                        left: 0;
                        position: absolute;">
            </div>
            <div class="elementor-container elementor-column-gap-default"
                style="max-width: 1140px;display: flex;
                    margin-right: auto;
                    margin-left: auto;
                    position: relative;">
                <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-d52a5ae"
                    data-id="d52a5ae" data-element_type="column" style="    width: 100%; min-height: 1px;">
                    <div class="elementor-widget-wrap elementor-element-populated"
                        style="padding: 10px;position: relative;
                        width: 100%;">
                        <div class="elementor-element elementor-element-c41b8ea elementor-widget elementor-widget-witr_section_call_to_ac"
                            data-id="c41b8ea" data-element_type="widget"
                            data-widget_type="witr_section_call_to_ac.default"
                            style="width: 100%; position: relative;">
                            <div class="elementor-widget-container">
                                <div class=" witr_5 all_cal_color talim_cen text-center"
                                    style="box-sizing: border-box; text-align: center!important;">
                                    <div class="row"
                                        style="flex-wrap: wrap; display: flex; margin-right: -15px; margin-left: -15px;">
                                        <div class="col-lg-12 col-md-12"
                                            style="flex: 0 0 100%;  max-width: 100%;     position: relative;
                                            width: 100%; min-height: 1px; padding-right: 15px;padding-left: 15px;">
                                            <div class="talim_content">
                                                <h2
                                                ...
                                                <div class="talim_button" style="margin-top: 45px;">
                                                    <a href="#"
                                                        style="border-radius: 3px;
                                                            font-size: 17px;
                                                            font-weight: 700;
                                                            font-family: 'Titillium Web', sans-serif;  background: #C15DFB;
                                                            padding: 15px 35px;
                                                            color: #fff;
                                                            display: inline-block; transition: 1s;
                                                            margin-right: 15px;">
                                                        Rechercher Mentor
                                                        <i aria-hidden="true" class="far fa-paper-plane"
