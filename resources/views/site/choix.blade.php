...
<body style="background-color:rgb(245, 244, 244) ">
    ...
    <main class="v-main pa-0 ma-0"
        ...
        <div class="v-main__wrap"
            ...
            <div class="container container--desktop"
                ...
                <div class="text-center" style="text-align: center!important;"><img src="/images/wave.svg">
                    <h2
                ...
                <div data-v-05f441a2="" class="v-card v-sheet theme--light card--desktop"
                    style="background: rgba(255, 255, 255, 0.911);
                        ...
                        position: relative;
                        white-space: normal;">
                    <div data-v-05f441a2="" class="text"
                    ...
                    <div data-v-05f441a2="" class="button-wrapper--desktop"
                        style="margin-top: 56px; height: 215px;display: flex;flex-direction: row;justify-content: center;text-align: center;">
                        <div onclick="selection('choix1')" class="button--desktop"
                            ...
                            <div id="choix1" onclick="selection('choix1')" class="img-wrapper"
                                style=" width: 200px;
                                        ...
                                        margin: auto;">
                                <img src="/images/kk.svg" alt="etudiant" class="img-svg"
                        ...
                        <div onclick="selection('choix2')" class="button--desktop"
                            ...
                            <div id="choix2" onclick="selection('choix2')" class="img-wrapper"
                                style=" width: 200px;
                                        ...
                                        box-sizing: border-box;
                                        margin: auto;">
                                <img style="height: 183px;width: 183px;" src="/images/tt.svg" alt="mentor"
                                    class="img-svg">
                            </div>
                ...
                <div onclick="etape()" class="continue--disabled active"
                    style="width: 152px; 
                        height: 33px;
                        border-radius: 3px;
                        margin: auto;
    ...
    <script>
        ...
        function selection(id) {
            if (id == "choix1") {
                document.getElementById(id).style.border = "2px solid #C15DFB";
                document.getElementById("choix2").style.border = "2px solid #000";
                choix = 1;
            } else {
                document.getElementById(id).style.border = "2px solid #C15DFB";
                document.getElementById("choix1").style.border = "2px solid #000";
                choix = 2;
            }
        }
