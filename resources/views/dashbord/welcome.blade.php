        ...
        <div class="container-fluid">
            <div class="row invoice-card-row">
                <div class="col-xl-4 col-xxl-3 col-sm-6">
                    <div class="card  invoice-card" style="background-color: #1cbef0;;">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                ...
                                <span class="text-white fs-18">Nombres de Mentorés Inscrits</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-xxl-3 col-sm-6">
                    <div class="card  invoice-card" style="background-color: #ccc;">
                        <div class="card-body d-flex">
                            <div class="icon me-3">
                            ...
                            <div>
                                ...
                                <span class="text-white fs-18">Nombre de Mentors Inscrits</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card bg-info invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                ...
                                <span class="text-white fs-18">Nombre de Projets par sessions</span>
                            </div>
                        </div>
                    </div>
                </div>
