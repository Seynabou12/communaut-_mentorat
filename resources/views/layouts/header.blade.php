                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <div id="dlab_W_TimeLine02" class="widget-timeline dlab-scroll style-1 ps p-3 height370">
                            <ul class="timeline">
                                <li>
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <div id="dlab_W_Notification1" class="widget-media dlab-scroll p-3 ps" style="height:380px;">
                                <ul class="timeline">
                                    <li>
