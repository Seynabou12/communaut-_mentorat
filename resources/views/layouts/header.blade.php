<div class="nav-header" style="margin-left: -20px; background: #ffff;;">
...
<div class="header" style="background-color: #ffff; height: 6rem;">
                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link ai-icon" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
                            ...
                            <span
                                class="badge light text-white rounded-circle" style="background: #C15DFB; color: black!important;">{{ count($notifications) }}</span>
                        </a>
