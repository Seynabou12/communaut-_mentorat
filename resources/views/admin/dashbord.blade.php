                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <ul class="card-list mt-3">
                                                    <li class="mb-2 h4" style="margin-top:50px; padding-top:10px; "><span class="bg-primary circle"></span><span
                                                            class="ms-0" style="color: black;">Mentors</span><span
                                                            class="text-black fs-18" style="font-weight: 100">{{ ($mentors->count() * 100) / ($mentors->count() + $mentores->count()) }}%</span>
                                                    </li>
                                                    <li class="mb-2 h4" style="margin-top:50px;"><span class="bg-black circle"></span><span
                                                            class="ms-0" style="color: black;">Mentorés</span><span
                                                            class="text-black fs-18" style="font-weight: 100">{{ ($mentores->count() * 100) / ($mentors->count() + $mentores->count()) }}%</span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-8">
